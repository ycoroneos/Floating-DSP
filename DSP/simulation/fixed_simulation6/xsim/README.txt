...
#
# Generated by export_simulation on Sat May 13 00:22:27 EDT 2017
#
################################################################################
...
switch to the './fir_fixed_file_tb.sh' script.

./fir_fixed_file_tb.sh -reset_run
...
./fir_fixed_file_tb.sh -noclean_files

For more information on the script, please type './fir_fixed_file_tb.sh -help'.
