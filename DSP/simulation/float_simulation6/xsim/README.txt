...
#
# Generated by export_simulation on Sat May 13 00:11:03 EDT 2017
#
################################################################################
...
switch to the './fir_floating_file_tb.sh' script.

./fir_floating_file_tb.sh -reset_run
...
./fir_floating_file_tb.sh -noclean_files

For more information on the script, please type './fir_floating_file_tb.sh -help'.
